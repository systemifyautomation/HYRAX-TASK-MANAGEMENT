      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 mb-8 border border-gray-200">
          <div className="flex items-center gap-4 mb-6">
            <div className="w-16 h-16 bg-gradient-to-br from-black to-red-600 rounded-xl flex items-center justify-center">
              <Info className="w-8 h-8 text-white" />
            </div>
            <div>
              <h1 className="text-4xl font-bold bg-gradient-to-r from-black to-red-600 bg-clip-text text-transparent">
                About HYRAX
              </h1>
              <p className="text-gray-600 mt-1">Task Management System</p>
            </div>
          </div>
        </div>
        ...
        {/* Creator Section */}
        <div className="bg-gradient-to-br from-black to-red-700 rounded-2xl shadow-xl p-8 text-white">
          ...
          <div className="space-y-4">
            ...
            <div className="pt-4 border-t border-red-500/30">
              <a 
                ...
                target="_blank" 
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 px-6 py-3 bg-white text-red-600 font-semibold rounded-lg hover:bg-red-50 transition-all transform hover:scale-105 shadow-lg"
              >
