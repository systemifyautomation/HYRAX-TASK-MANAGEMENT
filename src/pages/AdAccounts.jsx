...
const AdAccounts = () => {
  ...
  if (!isAdminUser) {
    return (
      <div className="p-8">
        <div className="bg-yellow-50 dark:bg-yellow-600 border border-yellow-200 dark:border-yellow-500 rounded-lg p-6">
          <h2 className="text-lg font-semibold text-yellow-800 dark:text-white mb-2">Access Denied</h2>
          <p className="text-yellow-700 dark:text-white">You don't have permission to view ad accounts.</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="p-8">
        ...
        <div className="mb-4 bg-white dark:bg-gray-800 rounded-lg shadow p-4">
          ...
          {(statusFilter !== 'all' || campaignFilter !== 'all' || pixelIdFilter !== 'all') && (
            <div className="mt-3 flex items-center gap-2 text-sm">
              ...
              {statusFilter !== 'all' && (
                <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-primary-100 dark:bg-primary-600 text-primary-800 dark:text-white">
                  Status: {statusFilter}
                </span>
              )}
              {campaignFilter !== 'all' && (
      ...
      {/* Error Message */}
      {error && (
        <div className="mb-4 p-4 bg-red-50 dark:bg-red-600 border border-red-200 dark:border-red-500 rounded-lg">
          <p className="text-red-800 dark:text-white">{error}</p>
        </div>
      )}
                          ...
                          {isEditing ? (
                            <div className="flex gap-2">
                              <button
                                ...
                                className="p-1.5 text-green-600 dark:text-white hover:bg-green-100 dark:hover:bg-green-700 rounded transition-colors"
                                title="Save"
                              >
                            ...
                            <div className="flex gap-2">
                              <button
                                ...
                                className="p-1.5 text-blue-600 hover:bg-blue-100 dark:hover:bg-blue-700 rounded transition-colors"
                                title="Edit"
                              >
                              ...
                              <button
                                ...
                                className="p-1.5 text-red-600 hover:bg-red-100 dark:hover:bg-red-700 rounded transition-colors"
                                title="Delete"
                              >
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl p-6 w-full max-w-md">
            <div className="flex items-center gap-3 mb-4">
              <div className="w-12 h-12 bg-red-100 dark:bg-red-600 rounded-full flex items-center justify-center">
                <Trash2 className="w-6 h-6 text-red-600 dark:text-white" />
              </div>
              <div>
